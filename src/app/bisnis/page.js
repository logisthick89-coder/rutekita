...
const TABS = [
  ...
  { id: 'panduan', label: 'Panduan', icon: '🗺️' },
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white/5 border border-amber-500/20 rounded-2xl p-5">
                <h3 className="text-sm font-bold text-white mb-3">⚠️ Tantangan</h3>
                <ul className="space-y-2.5">
                  {[
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                { icon: '🏛️', title: 'Dukungan Pemerintah', desc: 'Dishub Garut aktif mendukung peremajaan armada dan pengembangan rute baru untuk meningkatkan layanan.', color: 'border-blue-500/30' },
            ...
            <div className="bg-white/5 border border-amber-500/20 rounded-2xl p-5"
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                {[
                  { label: 'Harga unit angkot baru', value: '~Rp 150–200 jt', color: 'text-amber-300' },
                  { label: 'Pendapatan/hari (est.)', value: 'Rp 200–400 rb', color: 'text-emerald-300' },
                  { label: 'Biaya operasional/hari', value: '~Rp 100–150 rb', color: 'text-red-300' },
                  { label: 'Break even point (est.)', value: '3–5 tahun', color: 'text-violet-300' },
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { icon: '🛍️', label: 'Pedagang Pasar', desc: 'Rute pasar tradisional sangat ramai' },
                  { icon: '🏖️', label: 'Wisatawan Lokal', desc: 'Potensi rute wisata Garut Selatan' },
                ].map(({ icon, label, desc }) => (
        ...
        {activeTab === 'panduan' && (
          <div className="space-y-3">
            {[
              ...
              { step: '04', title: 'Rekrut & Kelola Pengemudi', desc: 'Rekrut pengemudi berpengalaman dengan SIM B1 Umum. Tetapkan sistem setoran harian yang adil (umumnya Rp 80.000–120.000/hari) agar pengemudi termotivasi menjaga kualitas layanan.', icon: '👤', color: 'border-amber-500/30' },
        ...
        {activeTab === 'rekomendasi' && (
          <div className="space-y-4">
            ...
            <div className="bg-white/5 border border-violet-500/20 rounded-2xl p-5">
              <h3 className="text-sm font-bold text-white mb-3">🗺️ Rute Paling Potensial</h3>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
              ...
              <div className="flex flex-col gap-3">
                {[
                  { icon: '👥', title: 'Sistem Patungan (Kongsi)', desc: 'Bergabung dengan 2–3 orang untuk membeli 1 unit bersama. Keuntungan dan risiko dibagi rata, cocok untuk pemula dengan modal terbatas.' },
            ...
            {/* Asosiasi & Komunitas */}
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
              <h3 className="text-sm font-bold text-white mb-3">🏛️ Asosiasi & Instansi Penting</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  { nama: 'Dishub Kabupaten Garut', fungsi: 'Izin trayek, regulasi, dan pengawasan operasional', icon: '🏛️' },
                  ...
                  { nama: 'BPJS Ketenagakerjaan', fungsi: 'Perlindungan pengemudi dari risiko kecelakaan kerja', icon: '🛡️' },
